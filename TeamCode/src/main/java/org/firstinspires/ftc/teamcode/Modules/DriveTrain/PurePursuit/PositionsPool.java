...
public class PositionsPool {
    ...
    public static Position redCenterEat      = new Position(0,0,0);
    public static Position blueCenterEat     = new Position(0,0,0);

    public static Position redCenterScoring  = new Position(0,0,0);
    public static Position blueCenterScoring = new Position(0,0,0);

    public static Position redBasketScoring  = new Position(0,0,0);
