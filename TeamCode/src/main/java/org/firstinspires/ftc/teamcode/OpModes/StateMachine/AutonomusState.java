...
public enum AutonomusState {
    START         (new State(IntakeState.WAIT_AXIS,new Position())),
    SCORING_AXE   (new State(IntakeState.WAIT_AXIS,new Position())),
    SCORING_BASKET(new State(IntakeState.WAIT_AXIS,new Position()));
    final State data;
