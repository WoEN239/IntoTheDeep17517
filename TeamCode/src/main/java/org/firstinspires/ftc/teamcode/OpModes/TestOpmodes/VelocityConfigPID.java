...
public class VelocityConfigPID extends BaseMode {
    ...
    @Override
    public void doing() {
      //  PositionPidController.isUpdate = false;
        DriveTrainMotors.initPid();
        //velPos.copyFrom(robot.velocityListener.getLocalVelocityListener().getVelocity());
...
//            robot.velocityPidController.moveLocal(velTarget);
//            n = 1;
//        }else{
//            robot.velocityPidController.moveLocal(new Position(-velTarget.x,-velTarget.y,-velTarget.h));
//            n = -1;
//        }
    }
}
